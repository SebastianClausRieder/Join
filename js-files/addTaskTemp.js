...
function renderAddTask(ID) {
    element(ID).innerHTML = /*html */ `
        <h1 id="add-task-title">Add Task</h1>
            ...
            <div class="formvalidation-left d-flex-start-column">
                <div class="input-fields d-flex-start-column">
                    ...
                    <div class="input-fields-contain d-flex-center">
                        <input type="text" id="title-input" class="input-fields-input font-inter"
                ...
                <div class="input-fields d-flex-start-column">
                    ...
                    <div class="input-fields-contain d-flex-center">
                        <textarea type="text" id="description-input"
                            class="input-fields-input description-input font-inter"
                    ...
                    <div class="input-fields-contain d-flex-center-column category">
                        <div class="selector-input-contain d-flex-center">
                            <input type="text" id="selector-category-input"
                                class="input-fields-input font-inter selector-input"
                ...
                <div class="formvalidation-right-contain d-flex-start-column">
                    <div class="input-fields d-flex-start-column">
                        ...
                        <div class="input-fields-contain d-flex-center-column due-date-contain">
                            <input type="date" id="due-date-input" class="input-fields-input font-inter">
                        </div>
                    ...
                    <div class="input-fields d-flex-start-column">
                        ...
                        <div class="input-fields-contain d-flex-center-column selector-add-to-task">
                            <div class="selector-input-contain d-flex-center">
                                <input type="text" id="selector-add-to-task-input"
                                    class="input-fields-input font-inter selector-add-to-task-input"
                                    placeholder="Add new Task">
                                <div id="selector-add-to-task-selected"
                                    class="selector-selected d-flex-start-center">
                                </div>
                                <div id="selector-add-to-task-select-contain"
                                    class="selector-btn d-flex-center" onclick="addNewTask()">
                    ...
                    <div class="input-fields d-flex-start-column">
                        ...
                        <div class="input-fields-contain d-flex-center subtask-contain">
                        ...
                        <div class="subtask-check-contain d-flex-start-center">
                            <span class="font-inter subtask-check-text">Show Subtask</span>
                            <div onclick="subtaskCheck()" id="subtask-checkbox"
                                class="checkbox d-flex-center">
                                <img src="" id="subtask-checkmark" class="checkmark">
                            </div>
                            <span id="subtask-request" class="request-area"></span>
                            <div id="your-subtasks" class="your-subtasks-contain d-flex-start-column"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="addTask-finish-btn-contain1 d-flex-center">
            ...
            <div id="addTask-message-area" class="addTask-finish-message-area d-flex-center">
                <div class="addTask-finish-message-contain d-flex-center">
...
function renderCloseBTN(onclickID) {
    element('board-add-task').innerHTML += /*html */ `
